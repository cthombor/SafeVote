...
adjusted for the number of ballots $n$ and the number of seats
$s$), and $c>0$ is the margin-scaling parameter `cMargin`.
...
$r+1$. Candidates with anything more than a small winning margin
have only a small rank adjustment, due to the exponential scaling.
