...
with \$0 \< j \< i\$. For example, valid ordered preferences are
`1; 1; 3; 4; …`, or `1; 2; 3; 3; 3; 6; …`, but NOT `1; 1; 2; 3; …`, or
NOT `1; 2; 3; 3; 3; 5; 6; …`. If the data contain such invalid votes,
they are automatically corrected and a warning is issued by calling the
